...
public class PlaceOrder extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel6.setBackground(new java.awt.Color(228, 203, 165));
        ...
        jPanel7.setBackground(new java.awt.Color(228, 203, 165));
    ...
    private void btnGenerateBillActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerateBillActionPerformed
        ...
        try (Document document = new Document(new PdfDocument(new PdfWriter(filePath)))) {
            ...
            document.add(new Paragraph("                                    Coffe Italy Sistema \n"));
            document.add(new Paragraph("Aqui estan los datos de tu pedido:"));
            document.add(new Paragraph("\tID del PEDIDO: " + billId + "\nNombre del Vendedor: " + customerName + " Total Pagado: " + grandTotal));
            ...
            document.add(table);
            document.add(new Paragraph("Gracias, por tu pedido, espero que haya sido de tu agrado"));
        ...
        setVisible(false);
        PlaceOrder order = new PlaceOrder(createdBy);
